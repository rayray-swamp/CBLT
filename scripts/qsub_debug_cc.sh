...
#$ -l h_rt=0:15:00
#$ -N dbgcc
#$ -o /gs/bs/tga-RLA/yoshida/blt_runs/auc_eval/debug_cc.out.log
#$ -e /gs/bs/tga-RLA/yoshida/blt_runs/auc_eval/debug_cc.err.log
...
python scripts/debug_crosscheck.py --ckpt-dir "$DST/consolidated"
rm -rf "$DST"; echo DONE
